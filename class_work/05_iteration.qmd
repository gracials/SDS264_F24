...
- Counts the number of coin flips until you get three heads in a row. 
...
mtcars |>
  summarize(
    across(.cols = everything(), .fns = mean, .names = "mean_{.col}"))

# pivot_loner function
...
iris |>
  summarize(across(everything(), n_distinct, .names = "distinct_{.col}"))
...
- Identifies the number of NAs on that specific year, month, and day for that variable. 
