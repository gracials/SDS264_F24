...
```{r}
#myapikey <- readLines("~/Desktop/gitSDS264_F24/census_api_key.txt")
```
...
# Finally using httr
url <- str_c("https://api.census.gov/data/2020/acs/acs5?get=NAME,B01003_001E,B19013_001E&for=tract:*&in=state:27&in=county:053", "&key=", "8bbdf13d04e7840bbcd63d72a1ceb52c872a48f6")
acs5 <- GET(url)
...
```{r}
acs_function(c(2019, 2020, 2021), c("B01003_001E", "B19013_001E"), "Hennepin") |>
  list_rbind()
```
