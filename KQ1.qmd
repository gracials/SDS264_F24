...
```{r}
summary_stats <- function(data, vars = where(is.numeric), stat_fcts) {
  data |>
    summarize(
    across({{vars}}, stat_fcts),
    n = n())
}
...
loop_function(samp_size = 30, n_means = 10000)
